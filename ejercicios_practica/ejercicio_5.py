...
if __name__ == '__main__':
    ...
    print(f'El número de personas que pasaron por el molinete es: {cantidad_personal} ')
    ...
    personal_id_ok = [x for x in accesos if x in id_validos]
    
    print(f'Los ids validos que ingresaron por el molinete son: {personal_id_ok}')
